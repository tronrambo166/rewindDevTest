							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-contact">
									...
									<div class="footer-contact-info">
										...
										<ul>	
											<li>
                              <a href="/refund" class="text-light font-weight-bold mb-3 d-block">Privacy Policy</a>
                              </li>
                ...
                <div class="footer-bottom">
					<div class="container-fluid">
						...
						<div class="copyright">
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="copyright-text">
										<p class="mb-0"><a>Copyright © 2022 OpdPoint All Rights Reserved. </a></p>
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
						 ...
						 <a href="https://opdpoint.com/Contact_Us/Contact_Us.html">| Contact us</a>
                              </li>
