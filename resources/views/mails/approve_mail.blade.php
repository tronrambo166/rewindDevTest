...
<!--Hidden Cart view-->
		...
		<h1 class="font-weight-bold py-3" style=" padding-top:30px; padding-bottom:20px; font-weight:bold; text-align:center;" > Rewind Cloud Radio</h1>
		 <br />Hey, your account has been approved! To complete sign up, just follow the link below! After completing the sign up, please follow the documentation carefully to setup social platforms. https://muziqyrewind.com/documentation</p>
